...
$(function(){
    ...
    console.log($('.drama-slide2 li.next a'));
    $('.drama-slide2 li.next a').click(function(){
        ...
        if($('.mainlist2 li').length>4){//多于4张图片
            ...
            if(ml<=0 && ml>w*-1){//默认图片显示时
                $('.swaplist2').css({left: '928px'});//交换图片放在显示区域右侧
                $('.mainlist2').animate({left: ml - 920 + 'px'},'slow');//默认图片滚动
                if(ml==(w-920)*-1){//默认图片最后一屏时
                    $('.swaplist2').animate({left: '0px'},'slow');//交换图片滚动
                }
            }else{//交换图片显示时
                $('.mainlist2').css({left: '928px'})//默认图片放在显示区域右
                $('.swaplist2').animate({left: sl - 920 + 'px'},'slow');//交换图片滚动
                if(sl==(w-920)*-1){//交换图片最后一屏时
    ...
    $('.drama-slide2 li.prev a').click(function(){
        ...
        if($('.mainlist2 li').length>4){
            ...
            if(ml<=0 && ml>w*-1){
                ...
                $('.mainlist2').animate({left: ml + 920 + 'px'},'slow');
                if(ml==0){
                    $('.swaplist2').animate({left: (w - 920) * -1 + 'px'},'slow');
                }
            }else{
                $('.mainlist2').css({left: (w - 920) * -1 + 'px'});
                $('.swaplist2').animate({left: sl + 920 + 'px'},'slow');
                if(sl==0){
